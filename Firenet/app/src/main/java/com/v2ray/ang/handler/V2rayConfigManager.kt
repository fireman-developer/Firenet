...
object V2rayConfigManager {
    ...
    private fun getV2rayNormalConfig(context: Context, guid: String, config: ProfileItem): ConfigResult {
        ...
        // شمارنده‌های آماری همیشه روشن می‌مانند. صفحه‌ی اصلی سرعت واقعی را از
        // همین شمارنده‌ها می‌خواند، نه از TrafficStats سیستم‌عامل که ترافیک
        // تونل را دو بار می‌شمارد. هزینه‌شان در حد چند شمارنده‌ی عدد صحیح است؛
        // `PREF_SPEED_ENABLED` فقط نمایش سرعت در نوتیفیکیشن را کنترل می‌کند.
